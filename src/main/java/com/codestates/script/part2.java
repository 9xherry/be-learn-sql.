...
public class part2 {
  ...
  */
  public static final String PART2_1 = "SELECT * FROM";
  ...
  */
  public static final String PART2_3 = "INSERT INTO user (name, email) VALUES ('heamin', 'heamin825@naver.com')";
  ...
  */
  public static final String PART2_8 = "SELECT content.title,user.name FROM content INNER JOIN user ON content.userID=user.id WHERE title IS NOT NULL";
  ...
  */
  public static final String PART2_10 = "INSERT INTO content (title, body, userId) VALUES ('STUDY', 'hard', '1')";
}
